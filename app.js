...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const APPS_DATA = {
    ...
    mat115: {
      ...
      category: 'material',
      description: 'ระบบสืบค้นและศึกษาพัสดุอุปกรณ์ก่อสร้างสายส่ง 115 เควี การไฟฟ้าส่วนภูมิภาค (PEA) จัดทำโดยกองมาตรฐานระบบไฟฟ้า (กมฟ.) ร่วมกับกองบริหารและจัดการคลังพัสดุ 4 (กคพ.4) รวบรวมรหัสพัสดุ SAP สเปกทางเทคนิค การจัดเก็บ และแผ่นคู่มือมาตรฐานความละเอียดสูง 111 หน้า เพื่อความสะดวกรวดเร็วในการปฏิบัติงาน เบิกจ่าย และติดตั้งอุปกรณ์ได้อย่างถูกต้องตามแบบมาตรฐาน กฟภ.',
      features: [
        'รวบรวม 9 หมวดหมู่งานก่อสร้าง 98 รายการอุปกรณ์หลัก รหัสพัสดุระบบ SAP กฟภ. 100%',
        'เปิดดูแผ่นคู่มือมาตรฐานคมชัดระดับ HD ทั้ง 111 หน้า พร้อมฟังก์ชันค้นหาและกระโดดไปยังหน้าอุปกรณ์',
        'ระบบค้นหาอัจฉริยะ ค้นหาด้วยชื่อไทย, ชื่ออังกฤษ, รหัสพัสดุ SAP (เช่น 1000010006) และเลขที่แบบ',
        'ระบบเปรียบเทียบสเปกอุปกรณ์ และระบบสร้างใบเบิกพัสดุ (BOM / Material Cart) ส่งออกเป็น Excel (CSV)',
        'ศูนย์ทดสอบความรู้และบัตรคำ (Flashcards / Quiz 4 ตัวเลือก) เสริมสร้างความเชี่ยวชาญหน้างาน'
      ]
    }
  };

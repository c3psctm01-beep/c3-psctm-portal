...
document.addEventListener('DOMContentLoaded', () => {
  // 1. Data Store for the 6 Main Applications
  const APPS_DATA = {
    dashboard: {
      id: 'dashboard',
      type: 'CONSTRUCTION & DISBURSEMENT DASHBOARD / CENTRAL REGION 3',
      title: 'PEA Construction & Disbursement Dashboard (กฟก.3)',
      url: 'https://dashboard-constrution-report.vercel.app/',
      image: 'assets/dashboard_card.svg',
      category: 'monitoring',
      description: 'ระบบแดชบอร์ดรายงานภาพรวมและสถิติงานก่อสร้างสายส่ง 115 kV และสถานีไฟฟ้า พร้อมระบบวิเคราะห์การเบิกจ่ายงบประมาณ WBS จัดทำขึ้นเพื่อสนับสนุนการติดตามงานของ กฟก.3 รวบรวมข้อมูลสถานะงานก่อสร้างสายส่ง 115 kV รายเดือน ประจำปี 2569, สถานะงานก่อสร้างสถานีไฟฟ้าตามแผนงานโครงการ 30 สถานี, รายละเอียดงบประมาณและการเบิกจ่ายจริง WBS (Actual vs Committed), งานขออนุญาตหน่วยงานภายนอก (ทางหลวง, รถไฟ, เจ้าท่า ฯลฯ) ตลอดจนแผนงาน Gantt Schedule และระบบนำเข้าไฟล์ Excel ตรวจสอบโครงสร้างอัตโนมัติ (Strict Schema Validation Engine)',
      features: [
        'รายงานสถานะงานก่อสร้างสายส่ง 115 kV รายเดือน และผลงานสะสมประจำปี 2569',
        'สรุปภาพรวมแผนงานสถานีไฟฟ้า 30 แห่ง (แล้วเสร็จ, อยู่ระหว่างดำเนินการ, รอจัดจ้าง)',
        'ติดตามและวิเคราะห์การเบิกจ่ายงบประมาณ WBS (งบปัจจุบัน, เบิกจริง Act., ภาระผูกพัน PR/PO, คงเหลือ)',
        'ตรวจสอบและคัดกรองสถานะงานขออนุญาตหน่วยงานภายนอก (Permit Tracking)',
        'แผนงานและผลงานความก้าวหน้าโครงการ (Gantt Schedule & S-Curve)',
        'ระบบนำเข้าไฟล์ Excel สรุปสถานะงานพร้อมตรวจจับโครงสร้าง (Strict Schema Validation) และพิมพ์รายงาน PDF'
      ]
    },
    pcts: {
      id: 'pcts',
    ...
    performance: {
      id: 'performance',
      type: 'WORK PERFORMANCE & TASK ASSIGNMENT / ผจส.กรย.(ก3)',
      title: 'ระบบรายงานการปฏิบัติงาน (Work Performance Report System)',
      url: 'https://work-performance.vercel.app/',
      image: 'assets/performance_card.svg',
      category: 'performance',
      description: 'ระบบรายงานและติดตามผลการปฏิบัติงานของพนักงาน แผนกจัดการงานก่อสร้างระบบส่งและสถานีไฟฟ้า (ผจส.) กองก่อสร้างระบบไฟฟ้าและงานโยธา (กรย.) ฝ่ายวิศวกรรมและบริการ การไฟฟ้าส่วนภูมิภาค เขต 3 (ภาคกลาง) ออกแบบเพื่อบริหารจัดการงานภายในแผนกอย่างมีประสิทธิภาพ รองรับทั้งพนักงานปฏิบัติการ (Staff) และหัวหน้างาน/ผู้ดูแล (Admin) มีระบบบันทึกรายงานประจำวัน มอบหมายงาน (Task Assignment) ตรวจสอบและอนุมัติรายงาน สรุปผลงานรายบุคคลและรายไตรมาส พร้อมเครื่องมือส่งออกสไลด์นำเสนอ PowerPoint (PPTX) และพิมพ์เอกสาร PDF อัตโนมัติ เชื่อมโยงระบบฐานข้อมูล Cloud Supabase',
      features: [
        'บันทึกรายงานการปฏิบัติงานประจำวัน พร้อมติดตามสถานะและประวัติรายงาน (My Reports)',
        'ระบบมอบหมายภารกิจงาน (Task Assignment) และตรวจสอบความคืบหน้าระหว่างหัวหน้างานกับผู้ปฏิบัติงาน',
        'ระบบตรวจสอบและอนุมัติรายงานการปฏิบัติงาน (Approval Workflow) สำหรับหัวหน้างาน/Admin',
        'แดชบอร์ดสรุปผลการปฏิบัติงานรายบุคคล (Employee Performance) และผลการดำเนินงานรายไตรมาส',
        'สร้างและส่งออกไฟล์นำเสนอ PowerPoint (.pptx) สำหรับรายงานผลงานผู้บริหาร พร้อมพิมพ์เอกสาร PDF',
        'ระบบบริหารจัดการผู้ใช้งาน การอนุมัติสิทธิ์ (Staff / Admin) และความปลอดภัยข้อมูลบน Supabase Cloud'
      ]
    },
    closecheck: {
      id: 'closecheck',
      type: 'SAP CLOSING AUDIT / BUDGET & MATERIAL REALLOCATION',
      title: 'ระบบติดตามและตรวจสอบการปิดงานก่อสร้าง (SAP ZPSR018)',
      url: 'https://project-close-check.vercel.app/',
      image: 'assets/closecheck_card.svg',
      category: 'closing',
      description: 'ระบบสารสนเทศเพื่อการติดตามและตรวจสอบความพร้อมในการปิดงานก่อสร้างในระบบ SAP พัฒนาขึ้นเพื่อแก้ปัญหาการปิดงานไม่ได้จากยอดงบประมาณติดลบหรือมีพัสดุค้างส่งคืน รองรับการนำเข้าไฟล์รายงาน SAP PDF (ZPSR018 / ZBUDR018) อัตโนมัติ ตรวจสอบความถูกต้อง 5 มิติหลัก วิเคราะห์ผลต่างงบประมาณ 10 หมวด และ 5 หมวดค่าใช้จ่ายหน้างาน พร้อมระบบคำนวณการโอนงบประมาณชดเชยยอดติดลบ และจัดทำรายงานผลการตรวจสอบแบบ กส.3',
      features: [
        'นำเข้าและประมวลผลรายงาน SAP PDF (ZPSR018 / ZBUDR018) โดยอัตโนมัติ',
        'ตรวจสอบเงื่อนไขการปิดงาน 5 มิติ (เอกสาร SAP, งบประมาณติดลบ, พัสดุค้างคืน, พัสดุขาดเบิก, แผนเดือนปิดงาน)',
        'วิเคราะห์ค่าใช้จ่ายหน้างาน 5 หมวด และจำลองการโอนงบประมาณ (Reallocation) ชดเชยยอดติดลบ',
        'ตรวจสอบบัญชีพัสดุและพิมพ์รายงาน กส.3 พร้อมตารางแสดงการโอนงบประมาณส่งแผนกบัญชี'
      ]
    },
    scrap: {
      id: 'scrap',
